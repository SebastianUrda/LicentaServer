...
import service.AnswerToObservationService;
...
@WebServlet(urlPatterns="/mightWork/answersToObservations")
public class AnswerToObservationServlet extends HttpServlet {
    AnswerToObservationService ansService= new AnswerToObservationService();
